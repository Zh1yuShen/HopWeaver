...
2.  **Prepare Core Data and Models:**
    ...
    *   **Download GTE Embedding Model:** Download the GTE model from [Hugging Face](https://huggingface.co/Alibaba-NLP/gte-multilingual-base) or [ModelScope](https://www.modelscope.cn/models/iic/gte_sentence-embedding_multilingual-base).
